                ...
                if($userid!=0){
                     ...
                     if($userinfo["usergrade"]=="3"){
                         ...
                         $msgid = Db::instance('db1')
                                  ...
                                  ->cols(array('roomid'=>$roominfo["roomid"],'time'=>$timenow,'majia'=>$majia,'tomajia'=>$tomajia, 'userid' =>$userinfo["userid"],'tonickname'=>$jieshounickname,'touserid'=>$jieshouuserid,'gradeid' =>$userinfo["gradeid"] , 'nickname' => $userinfo["nickname"], 'webaddress' => $webaddress, 'cstatus' => '0', 'msgcontent' => $content))->limit(1)->query();
...
//                               $content= base64_encode($content);
                                ...
                                //定义返回的聊天消息
                                $sendMsg = array('type' => 'chat','timenow'=>$timenow,'code'=>'11','majia'=>$majia,'tomajia'=>$tomajia,'msgid'=>$msgid,'tonickname'=>$jieshounickname,'touserid'=>$jieshouuserid, 'content' => $content,'userid' => '0', 'webaddress' => $webaddress,'gradeid' => '0', 'nickname' => $_SESSION["touristnickname"]);
...
//                                   $content= base64_encode($content);
                                ...
                                $sendMsg = array('type' => 'chat','timenow'=>$timenow,'majia'=>$majia,'tomajia'=>$tomajia,'code'=>'11','msgid'=>$msgid,'tonickname'=>$jieshounickname,'touserid'=>$jieshouuserid , 'content' => $content ,'userid' => $userinfo["userid"], 'webaddress' => $webaddress,'gradeid' => $userinfo['gradeid'], 'nickname' =>$username);

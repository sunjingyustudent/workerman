<html><head>
  ...
  <script type="text/javascript">
    ...
    function connect() {
       // 创建websocket
       ws = new WebSocket("ws://120.26.72.218:7273");
       // 当socket连接打开时，输入用户名
       ws.onopen = onopen;
       // 当有消息时根据消息类型显示不同信息
    ...
    function onopen()
    {
        ...
        ws.send('{"type":"login","accesstoken":"wht1-token-450041672289483b6a7d556d45987f51","roomid":"132"}');
    ...
    /*  ws.send('{"type":"say","to_client_id":"'+to_client_id+'","to_client_name":"'+to_client_name+'","content":"'+input.value.replace(/"/g, '\\"').replace(/\n/g,'\\n').replace(/\r/g, '\\r')+'"}');*/
        //ws.send('{"type":"sendredpacket","amount":"100","num":"4","webcastid":"1"}');
        //ws.send('{"type":"getredpacket","redpacketid":"24","userid":"2"}');
        //ws.send('{"type":"gifts","frmuserid":"24","touserid":"2","webcastid":"1","giftprice":"100","giftname":"xixi"}');
       // ws.send('{"type":"chat","content":"234","webadress":"2","webcastid":"1"}');
      // ws.send('{"type":"gifts","touserid":"2","webcastid":"1","webcastkey":"1","giftid":"1","giftprice":"100","giftname":"大熊猫"}');
     //ws.send('{"type":"sendredpacket","amount":"0.1","webcastid":"1","num":"4"}');
        //ws.send('{"type":"getredpacket","redpacketid":"50"}');
        ws.send('{"type":"redpacketdetail","redpacketid":"50"}');
        input.value = "";
      input.focus();
    }
